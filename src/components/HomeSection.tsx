        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
              ...
              <span className="text-cyan-400">louder</span>.
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl">
              Digital Marketing Executive crafting growth strategies powered by data and design.
            </p>

            <button 
              onClick={scrollToHireMe}
              className="group inline-flex items-center px-8 py-4 bg-cyan-400 text-black font-semibold rounded-full hover:bg-white transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-cyan-400/25"
            >
              Hire Me
