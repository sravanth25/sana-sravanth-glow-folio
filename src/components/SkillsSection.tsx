      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className={`${isVisible ? 'animate-fade-in' : 'opacity-0'} transition-opacity duration-700 delay-500`}>
            ...
            }} className="bg-gray-800/50 p-4 text-center hover:bg-gray-800/70 hover:scale-105 transition-all duration-300 cursor-pointer border border-gray-700 hover:border-cyan-400/50 rounded-md">
