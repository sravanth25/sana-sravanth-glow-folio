...
const SkillsSection = () => {
  ...
  const tools = [
    'Google Ads', 'Meta Ads', 'GA4', 'SEMrush', 'Canva', 'Looker Studio',
          ...
          <div className={`${isVisible ? 'animate-fade-in' : 'opacity-0'} transition-opacity duration-700 delay-500`}>
            ...
            <div className="grid grid-cols-2 gap-4">
              {tools.map((tool, index) => (
                <div
                  key={tool}
                  className="bg-gray-800/50 p-4 rounded-xl text-center hover:bg-gray-800/70 hover:scale-105 transition-all duration-300 cursor-pointer border border-gray-700 hover:border-cyan-400/50"
